...
def test_figure03_reported_statistics_match_canonical_run(tmp_path: Path) -> None:
    ...
    np.testing.assert_allclose(
        ...
        np.array(
            [
                [1.507, 1.835, 22.595, 0.895, 2.103, 10.659, 2.105, 0.000],
                [2.603, 2.876, 23.925, 1.501, 2.686, 13.672, 3.055, 0.000],
                [0.949, 1.163, 18.689, 0.506, 1.178, 8.097, 1.372, 56.250],
            ]
        ),
        atol=5e-4,
        rtol=0.0,
    ...
    np.testing.assert_allclose(
        ...
        np.array(
            [
                [1.755, 1.788, 41.822, 1.906, 36.998, 7.951, 46.848, 4.249],
