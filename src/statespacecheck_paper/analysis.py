...
goodness-of-fit. The shared diagnostic layer (``SpikeEventDiagnostics``,
``DecodingDiagnostics``, ``DiagnosticThresholds``, the per-spike-event computation,
and the baseline-threshold estimation) lives in
:mod:`statespacecheck_paper.diagnostics`.
