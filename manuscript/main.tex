...
\caption{Per-spike goodness-of-fit diagnostics on real hippocampal recordings during W-track running. (a) Longer context window showing the surrounding run periods. (b) Zoomed-in detail view under a Continuous decoder. (c) The same detail view under a Continuous--Fragmented decoder.}
\label{fig:real_data}
\end{figure}
