...
The simulation applies a Bayesian filter to a 32-second session in which the generative process and decoder agree except during four misspecification windows. Each window perturbs one component of the otherwise matched model.
