...
script adds the pooled-realization threshold/summary estimate and the figure
...
def generate_figure03(config: Figure3Config, *, n_realizations: int = N_REALIZATIONS) -> None:
...
def main() -> None:
    """CLI entry point: build the canonical config and generate Figure 3."""
